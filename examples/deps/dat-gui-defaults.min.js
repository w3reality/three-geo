    ...
    function (e, t, n) {
      ...
      var i = (function () {
        ...
        a = (function () {
          ...
          return (
            i(e, [
              { key: "initGui", value: function (e, t, n) {} },
              {
                key: "setDefaults",
                value: function (e) {
                  (this.defaults = e),
    ...
    function (e, t, n) {
      ...
      function m(e, t, n) {
        if (
          ...
          R.extend(n, {
            options: function (t) {
              ...
              if (R.isArray(t) || R.isObject(t)) {
                ...
                return (
                  n.remove(),
                  g(e, n.object, n.property, { before: i, factoryArgs: [t] })
                );
              }
            },
            name: function (e) {
          ...
          (n.min = R.compose(i, n.min)), (n.max = R.compose(i, n.max));
        } else
          n instanceof W
            ? (J.bind(t, "click", function () {
                J.fakeEvent(n.__checkbox, "click");
              }),
              J.bind(n.__checkbox, "click", function (e) {
                e.stopPropagation();
              }))
            : n instanceof te
            ? (J.bind(t, "click", function () {
                J.fakeEvent(n.__button, "click");
              }),
              J.bind(t, "mouseover", function () {
                J.addClass(n.__button, "hover");
              }),
              J.bind(t, "mouseout", function () {
                J.removeClass(n.__button, "hover");
              }))
            : n instanceof ne &&
              (J.addClass(t, "color"),
              (n.updateDisplay = R.compose(function (e) {
                return (t.style.borderLeftColor = n.__color.toString()), e;
              }, n.updateDisplay)),
              n.updateDisplay());
        n.setValue = R.compose(function (t) {
          return (
            e.getRoot().__preset_select && n.isModified() && p(e.getRoot(), !0),
            t
          );
        }, n.setValue);
      }
      ...
      function g(e, t, n, o) {
        ...
        var i = void 0;
        if (o.color) i = new ne(t, n);
        else {
          var r = [t, n].concat(o.factoryArgs);
          i = re.apply(e, r);
        }
        o.before instanceof U && (o.before = o.before.__li),
          b(e, i),
          J.addClass(i.domElement, "c");
        var s = document.createElement("span");
        J.addClass(s, "property-name"), (s.innerHTML = i.property);
        var a = document.createElement("div");
        a.appendChild(s), a.appendChild(i.domElement);
        var l = h(e, a, o.before);
        return (
          J.addClass(l, me.CLASS_CONTROLLER_ROW),
          i instanceof ne
            ? J.addClass(l, "color")
            : J.addClass(l, D(i.getValue())),
          m(e, l, i),
      ...
      function x(e) {
        ...
        if (
          (e.load && e.load.remembered
            ? R.each(e.load.remembered, function (t, n) {
                y(e, n, n === e.preset);
              })
            : y(e, de, !1),
          ...
          (document.getElementById("dg-save-locally").style.display = "block"),
            ...
            w(e, a),
            J.bind(l, "change", function () {
              (e.useLocalStorage = !e.useLocalStorage), w(e, a);
            });
        }
        var d = document.getElementById("dg-new-constructor");
        J.bind(d, "keydown", function (e) {
      ...
      function E(e) {
        ...
        function n() {
          J.removeClass(e.__closeButton, me.CLASS_DRAG),
            J.unbind(window, "mousemove", t),
            J.unbind(window, "mouseup", n);
        }
        function o(o) {
          return (
            o.preventDefault(),
            (i = o.clientX),
            J.addClass(e.__closeButton, me.CLASS_DRAG),
            J.bind(window, "mousemove", t),
            J.bind(window, "mouseup", n),
            !1
          );
        }
        var i = void 0;
        (e.__resize_handle = document.createElement("div")),
          R.extend(e.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
      ...
      function A(e, t) {
        var n = {};
        return (
          R.each(e.__rememberedObjects, function (o, i) {
            var r = {},
      ...
      var O = Array.prototype.forEach,
        ...
        R = {
          ...
          compose: function () {
            ...
            return function () {
              for (var t = T.call(arguments), n = e.length - 1; n >= 0; n--)
                t = [e[n].apply(this, t)];
              return t[0];
            };
          },
          each: function (e, t, n) {
            if (e)
              if (O && e.forEach && e.forEach === O) e.forEach(t, n);
          ...
          debounce: function (e, t, n) {
            ...
            return function () {
              ...
              var r = this,
                s = arguments,
                a = n || !o;
              clearTimeout(o), (o = setTimeout(i, t)), a && e.apply(r, s);
            };
          },
          toArray: function (e) {
        ...
        H = function () {
          ...
          return (
            R.each(L, function (t) {
              if (t.litmus(e))
                return (
                  R.each(t.conversions, function (t, n) {
                    if (((B = t.read(e)), !1 === N && !1 !== B))
                      return (
                        (N = B),
                        (B.conversionName = n),
                        (B.conversion = t),
      ...
      (G.recalculateRGB = function (e, t, n) {
        if ("HEX" === e.__state.space)
          e.__state[t] = P.component_from_hex(e.__state.hex, n);
        else {
          if ("HSV" !== e.__state.space)
            throw new Error("Corrupted color state");
          R.extend(
            e.__state,
            P.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v)
          );
        }
      }),
        (G.recalculateHSV = function (e) {
          var t = P.rgb_to_hsv(e.r, e.g, e.b);
          R.extend(e.__state, { s: t.s, v: t.v }),
            R.isNaN(t.h)
          ...
          get: function () {
            return (
              "HEX" !== !this.__state.space &&
                (this.__state.hex = P.rgb_to_hex(this.r, this.g, this.b)),
              this.__state.hex
            );
          },
          set: function (e) {
      ...
      var Y = /(\d+(\.\d+)?)px/,
        J = {
          ...
          fakeEvent: function (e, t, n, o) {
            ...
            R.defaults(s, o), e.dispatchEvent(s);
          },
        ...
        W = (function (e) {
          function t(e, n) {
            ...
            return (
              ...
              J.bind(i.__checkbox, "change", o, !1),
        ...
        Q = (function (e) {
          function t(e, n, o) {
            ...
            var i = z(
              ...
              s = i;
            if (
              ((i.__select = document.createElement("select")), R.isArray(r))
            ) {
              var a = {};
              R.each(r, function (e) {
                a[e] = e;
            ...
            return (
              ...
              i.updateDisplay(),
              J.bind(i.__select, "change", function () {
        ...
        q = (function (e) {
          function t(e, n) {
            ...
            return (
              ...
              J.bind(r.__input, "keyup", o),
              J.bind(r.__input, "change", o),
              J.bind(r.__input, "blur", i),
              J.bind(r.__input, "keydown", function (e) {
        ...
        Z = (function (e) {
          function t(e, n, o) {
            ...
            return (
              ...
              (i.__precision = a(i.__impliedStep)),
              i
            );
          }
          return (
        ...
        $ = (function (e) {
          function t(e, n, o) {
            ...
            function a(e) {
              var t = _ - e.clientY;
              u.setValue(u.getValue() + t * u.__impliedStep), (_ = e.clientY);
            }
            function l() {
              J.unbind(window, "mousemove", a),
                J.unbind(window, "mouseup", l),
                r();
            }
            function d(e) {
              J.bind(window, "mousemove", a),
                J.bind(window, "mouseup", l),
                (_ = e.clientY);
            }
            F(this, t);
            var c = z(
            ...
            return (
              ...
              J.bind(c.__input, "change", i),
              J.bind(c.__input, "blur", s),
              J.bind(c.__input, "mousedown", d),
              J.bind(c.__input, "keydown", function (e) {
                13 === e.keyCode &&
                  ((u.__truncationSuspended = !0),
                  this.blur(),
        ...
        ee = (function (e) {
          function t(e, n, o, i, r) {
            ...
            function a(e) {
              ...
              return (
                f.setValue(d(e.clientX, t.left, t.right, f.__min, f.__max)), !1
              );
            }
            function l() {
              J.unbind(window, "mousemove", a),
            ...
            function c(e) {
              1 === e.touches.length &&
                ...
                J.bind(window, "touchend", _),
                u(e));
            }
            function u(e) {
              var t = e.touches[0].clientX,
                n = f.__background.getBoundingClientRect();
              f.setValue(d(t, n.left, n.right, f.__min, f.__max));
            }
            function _() {
              J.unbind(window, "touchmove", u),
                J.unbind(window, "touchend", _),
                f.__onFinishChange && f.__onFinishChange.call(f, f.getValue());
            }
            F(this, t);
            var h = z(
            ...
            return (
              ...
              J.bind(h.__background, "mousedown", s),
              J.bind(h.__background, "touchstart", c),
        ...
        te = (function (e) {
          function t(e, n, o) {
            ...
            return (
              ...
              J.bind(i.__button, "click", function (e) {
                return e.preventDefault(), r.fire(), !1;
              }),
              J.addClass(i.__button, "button"),
        ...
        ne = (function (e) {
          function t(e, n) {
            function o(e) {
              d(e),
                J.bind(window, "mousemove", d),
                J.bind(window, "touchmove", d),
                J.bind(window, "mouseup", r),
                J.bind(window, "touchend", r);
            }
            function i(e) {
              _(e),
                J.bind(window, "mousemove", _),
                J.bind(window, "touchmove", _),
                J.bind(window, "mouseup", s),
                J.bind(window, "touchend", s);
            }
            function r() {
              J.unbind(window, "mousemove", d),
            ...
            function s() {
              J.unbind(window, "mousemove", _),
                J.unbind(window, "touchmove", _),
            ...
            function l() {
              f.__onFinishChange &&
                f.__onFinishChange.call(f, f.__color.toOriginal());
            }
            function d(e) {
            ...
            (h.__color = new G(h.getValue())), (h.__temp = new G(0));
            var f = h;
            (h.domElement = document.createElement("div")),
              J.makeSelectable(h.domElement, !1),
              ...
              J.bind(h.__input, "keydown", function (e) {
                13 === e.keyCode && a.call(this);
              }),
              J.bind(h.__input, "blur", a),
              J.bind(h.__selector, "mousedown", function () {
                J.addClass(this, "drag").bind(window, "mouseup", function () {
                  J.removeClass(f.__selector, "drag");
                });
              }),
              J.bind(h.__selector, "touchstart", function () {
            ...
            return (
              ...
              R.extend(h.__saturation_field.style, {
                width: "100px",
                height: "100px",
              ...
              c(p, "top", "rgba(0,0,0,0)", "#000"),
              R.extend(h.__hue_field.style, {
                width: "15px",
                height: "100px",
                border: "1px solid #555",
                cursor: "ns-resize",
              ...
              J.bind(h.__saturation_field, "mousedown", o),
              J.bind(h.__saturation_field, "touchstart", o),
              J.bind(h.__field_knob, "mousedown", o),
              J.bind(h.__field_knob, "touchstart", o),
              J.bind(h.__hue_field, "mousedown", i),
              J.bind(h.__hue_field, "touchstart", i),
              h.__saturation_field.appendChild(p),
                  ...
                  if (!1 !== e) {
                    ...
                    R.each(
                      ...
                      function (n) {
                        if (
                          !R.isUndefined(e[n]) &&
                          !R.isUndefined(this.__color.__state[n]) &&
        ...
        re = function (e, t) {
          var n = e[t];
          return R.isArray(arguments[2]) || R.isObject(arguments[2])
            ? new Q(e, t, arguments[2])
            : R.isNumber(n)
            ? R.isNumber(arguments[2]) && R.isNumber(arguments[3])
              ? R.isNumber(arguments[4])
                ? new ee(e, t, arguments[2], arguments[3], arguments[4])
                : new ee(e, t, arguments[2], arguments[3])
              : R.isNumber(arguments[4])
              ? new $(e, t, {
                  min: arguments[2],
                  max: arguments[3],
              ...
              : new $(e, t, { min: arguments[2], max: arguments[3] })
            : R.isString(n)
            ? new q(e, t)
            : R.isFunction(n)
            ? new te(e, t, "")
        ...
        ae = (function () {
          function e() {
            F(this, e),
              ...
              R.extend(this.backgroundElement.style, {
              ...
              },
              {
                ...
                value: function () {
                  (this.domElement.style.left =
                    window.innerWidth / 2 -
                    J.getWidth(this.domElement) / 2 +
                    "px"),
                    (this.domElement.style.top =
                      window.innerHeight / 2 -
                      J.getHeight(this.domElement) / 2 +
                      "px");
                },
              },
            ]),
      ...
      var de = "Default",
        ...
        me = function e(t) {
          ...
          (this.domElement = document.createElement("div")),
            ...
            R.isUndefined(o.load)
              ? (o.load = { preset: de })
              : o.preset && (o.load.preset = o.preset),
            R.isUndefined(o.parent) && o.hideable && pe.push(this),
            (o.resizable = R.isUndefined(o.parent) && o.resizable),
            o.autoPlace && R.isUndefined(o.scrollable) && (o.scrollable = !0);
          var i = ce && "true" === localStorage.getItem(v(this, "isLocal")),
            r = void 0;
          if (
            (Object.defineProperties(this, {
              ...
              closed: {
                ...
                set: function (t) {
                  (o.closed = t),
                    o.closed
                      ? J.addClass(n.__ul, e.CLASS_CLOSED)
                      : J.removeClass(n.__ul, e.CLASS_CLOSED),
                    this.onResize(),
                    n.__closeButton &&
              ...
              useLocalStorage: {
                ...
                set: function (e) {
                  ce &&
                    ((i = e),
                    e
                      ? J.bind(window, "unload", r)
                      : J.unbind(window, "unload", r),
                    localStorage.setItem(v(n, "isLocal"), e));
                },
              },
            }),
            R.isUndefined(o.parent))
          ) {
            if (
              ((o.closed = !1),
              J.addClass(this.domElement, e.CLASS_MAIN),
              J.makeSelectable(this.domElement, !1),
              ce && i)
            ) {
              n.useLocalStorage = !0;
              var s = localStorage.getItem(v(this, "gui"));
            ...
            (this.__closeButton = document.createElement("div")),
              ...
              o.closeOnTop
                ...
                : (J.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM),
          ...
          o.autoPlace &&
            ...
            (r = function () {
              ce &&
                "true" === localStorage.getItem(v(n, "isLocal")) &&
      ...
      (me.toggleHide = function () {
        ...
        J.bind(window, "keydown", me._keydownHandler, !1),
        R.extend(me.prototype, {
          add: function (e, t) {
            return g(this, e, t, {
          ...
          destroy: function () {
            ...
            R.each(this.__folders, function (t) {
              ...
              J.unbind(window, "keydown", me._keydownHandler, !1),
              f(this);
          },
          ...
          onResize: function () {
            ...
            if (e.scrollable) {
              ...
              R.each(e.__ul.childNodes, function (t) {
                (e.autoPlace && t === e.__save_row) || (n += J.getHeight(t));
              }),
                window.innerHeight - t - 20 < n
                  ? (J.addClass(e.domElement, me.CLASS_TOO_TALL),
                    (e.__ul.style.height = window.innerHeight - t - 20 + "px"))
                  : (J.removeClass(e.domElement, me.CLASS_TOO_TALL),
          ...
          getSaveObject: function () {
            ...
            return (
              ...
              this.__rememberedObjects.length > 0 &&
                ...
                (e.remembered[this.preset] = A(this))),
              (e.folders = {}),
              R.each(this.__folders, function (t, n) {
          ...
          saveAs: function (e) {
            this.load.remembered ||
              ((this.load.remembered = {}),
              (this.load.remembered[de] = A(this, !0))),
              (this.load.remembered[e] = A(this)),
              (this.preset = e),
              y(this, e, !0),
              this.saveToLocalStorageIfPossible();
          },
      ...
      var be = { Color: G, math: P, interpret: H },
        ge = {
          Controller: U,
          BooleanController: W,
          OptionController: Q,
        ...
        ye = { GUI: me },
        we = me,
        xe = { color: be, controllers: ge, dom: ve, gui: ye, GUI: we };
      t.default = xe;
    },
  ]);
});
