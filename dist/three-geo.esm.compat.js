/*! For license information please see three-geo.esm.compat.js.LICENSE.txt */
<<<<<<< HEAD
!(function (t, e) {
  ...
  (e = (() => {
    var t = {
        ...
        7701: (t, e, r) => {
          ...
          function l(t, e) {
            for (
              var r, n, i, o, a, s = Object.keys(t), u = 0;
              u < s.length;
              u++
            )
              e.push(
        ...
        7057: (t, e) => {
          ...
          function n(t, e, n) {
            return (
              void 0 === n && (n = {}),
              r({ type: "Point", coordinates: t }, e, n)
            );
          }
          function i(t, e, n) {
            void 0 === n && (n = {});
        ...
        4963: (t, e, r) => {
          ...
          (e.getCoord = function (t) {
            ...
            (e.containsNumber = function t(e) {
              if (e.length > 1 && n.isNumber(e[0]) && n.isNumber(e[1]))
                return !0;
          ...
          function u(t, e) {
            s(t, function (t, r, i, o, a) {
              ...
              switch (u) {
                ...
                case "Polygon":
                  return (
                    !1 !== e(n.feature(t, i, { bbox: o, id: a }), r, 0) &&
                    void 0
                  );
              }
              switch (u) {
        ...
        1984: (t, e, r) => {
          ...
          function a(t) {
            for (
              var e = new Array(t.length), r = !0, n = 0;
              n < t.length;
              ++n
            ) {
              var i = t[n],
          ...
          t.exports = function (t, e) {
            ...
            for (
              (m = m.concat(E)).length > 0 && b.push("var " + m.join(",")),
                l = 0;
              l < t.arrayArgs.length;
              ++l
            )
        ...
        4459: (t, e, r) => {
          ...
          (S.prototype.read = function (t) {
            ...
            (S.prototype.removeAllListeners = function (t) {
              ...
              return (
                ("readable" !== t && void 0 !== t) || process.nextTick(O, this),
                e
              );
            }),
        ...
        7722: (t, e, r) => {
          ...
          c.Delta = class {
            ...
            async init(t = { nodejs: !1 }) {
              if (t.nodejs) {
                const { performance: t } = await c.nodeRequire(
                  r.g,
                  "perf_hooks"
                );
                this.perf = t;
          ...
          const j = function (t, e, r, n) {
            ...
            var a = (0, w.convertLength)(e, i, "meters"),
              ...
              u = (function (t, e, r, n) {
                ...
                var h = Math.log(
                    Math.tan(l / 2 + Math.PI / 4) /
                      Math.tan(a / 2 + Math.PI / 4)
                  ),
                    ...
                    return (
                      t.forEach(function (l) {
                        var h = Z(l, 3),
                          ...
                          p = h[2];
                        if (49152 === c.length) {
                          var d = a.resolveSeams(
                              c,
                              a.getNeighborsInfo(t, s, f)
                            ),
              ...
              (r = [
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this;
                    if (
                      (this.dataEleCovered, 0 === this.dataEleCovered.length)
                    ) {
                      var r = [];
                      return (
                        this.onRgbDem(r),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    this.onVectorDem && this.onVectorDem(r),
                      this.watcher &&
                        this.watcher({ what: "dem-vec", data: r });
                  },
                },
                {
                  ...
                  },
                  {
                    ...
                    value: function (t, e, r, n) {
                      var i = yt(t, 2),
                        ...
                        f = s[3],
                        c = yt(
                          this._projectCoord(n, [a, o], [u, f], [h, l]),
                          2
                        ),
                        p = c[0],
                        d = c[1],
              ...
              1 === e
                ...
                : (o.push("Object.defineProperty(proto,'order',{get:"),
                  e < 4
                    ...
                    : o.push("ORDER})")),
              o.push(
                "proto.set=function " + r + "_set(" + u.join(",") + ",v){"
              ),
              i
        ...
        2676: function (t) {
          t.exports = (function () {
            ...
            function f(t, e, r, i) {
              ...
              if (o > 0) {
                var a = r + Math.floor(o / 2),
                  ...
                  l = new n(s, u);
                return (
                  (l.left = f(t, e, r, a)), (l.right = f(t, e, a + 1, i)), l
                );
              }
              return null;
            }
            ...
            function p(t) {
              for (
                var e = t, r = [], i = !1, o = new n(null, null), a = o;
                !i;
                  ...
                  r(e, [
                    {
                      ...
                      value: function (t) {
                        if (t.point === this.point)
                          throw new Error(
                            "Tried to link already linked events"
                          );
                        for (
                  ...
                  r(e, [
                    {
                      ...
                      value: function (t, e, r) {
                        ...
                        for (
                          ...
                          n.push(new U(r[i], !1));
                        if (
                          ((G.numMultiPolys = n.length),
                          "difference" === G.type)
                        )
                          for (var a = n[0], s = 1; s < n.length; )
                            null !== b(n[s].bbox, a.bbox)
                              ? s++
                              : n.splice(s, 1);
